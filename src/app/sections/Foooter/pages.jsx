export default function Footer() {
  return (
    <footer className="bg-white text-white py-4 ">
      <div className="text-center  font-manrope text-black text-sm uppercase tracking-wider">
            ...
            <div className="space-y-4 font-playfair">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <div className="flex flex-wrap gap-4 items-start">
                  <h1 className="text-sx md:text-sm leading-tight">
                    seriously.
                  </h1>
                  <div className="flex flex-col  font-manrope text-xs ">
                    <p>HOME</p>
                    <p>VIKTORIA</p>
                    <p>DESIGN</p>
                  </div>
              ...
              <div className="text-sm font-manrope text-white">
                <p>Viktória Rétfalvi</p>
                <p>hi@vhd.hu</p>
                <div className="flex justify-between items-center gap-40 w-full font-manrope text-white whitespace-nowrap">
                  {/* Phone Number */}
                  <div className="w-fit">
